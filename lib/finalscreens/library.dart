                                ...
                                builder: (context, snapshot) {
                                  return (snapshot.connectionState ==
                                    ...
                                    itemBuilder: (context, index) {
                                      QueryDocumentSnapshot d = snapshot.data!
                                          .docs[index];
                                      if (d != null) {
                                        return Column(
                                            children: [
                                              playlistsbutton(orient: "v",
                                                  width: 140,
                                                  height: 160,
                                                  imgname: d["img"],
                                                  playlistname: d["name"].toString(),
