...
class indi_music extends StatefulWidget {
  indi_music ({super.key});

  @override
  State<indi_music> createState() => _indiState();
}
class _indiState extends State<indi_music> {
  ...
  void initPlayer() async {
    ...
    songname=prefs!.getStringList("queue")![prefs!.getInt("curr")!];
        ...
        child: Scaffold(
          ...
          body : Column(
            ...
            children: [
              ...
              Container(height: 10,),
              Text(songname,style: TextStyle(fontSize: 20,color: Colors.white),),
